  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <pre class="language-yaml"><code>cdn_version: 3.4.7</code></pre>
      </td>
    </tr>
    <tr>
      <td class="col-xs-3">
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <pre class="language-yaml"><code>cdn_custom: "https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/css/bootstrap.css
https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/css/bootstrap.min.css
https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/js/bootstrap.js
https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/js/bootstrap.min.js"</code></pre>
      </td>
    </tr>
      </tbody>
</table>
...
<table class="table table-responsive">
  ...
  <tr class="bg-warning">
      ...
      <td>
        ...
        <pre class="language-yaml"><code>cdn_jsdelivr_version: 3.4.7</code></pre>
        <div class="alert alert-danger alert-sm">
  ...
  <tr class="bg-warning">
      ...
      <td>
        ...
        <pre class="language-yaml"><code>cdn_custom_css: 'https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/css/bootstrap.css'</code></pre>
        <div class="alert alert-danger alert-sm">
  ...
  <tr class="bg-warning">
      ...
      <td>
        ...
        <pre class="language-yaml"><code>cdn_custom_css_min: 'https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/css/bootstrap.min.css'</code></pre>
        <div class="alert alert-danger alert-sm">
          <strong>Deprecated since 8.x-3.18</strong> - Replaced with new setting. Will be removed in a future release. (see: <a href="#cdn-custom">cdn_custom</a>)
        </div>
      </td>
  ...
  <tr class="bg-warning">
      ...
      <td>
        <div class="help-block">It is best to use <code>https</code> protocols here as it will allow more flexibility if the need ever arises.</div>
        <pre class="language-yaml"><code>cdn_custom_js: 'https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/js/bootstrap.js'</code></pre>
        <div class="alert alert-danger alert-sm">
          <strong>Deprecated since 8.x-3.18</strong> - Replaced with new setting. Will be removed in a future release. (see: <a href="#cdn-custom">cdn_custom</a>)
        </div>
      </td>
  ...
  <tr class="bg-warning">
      ...
      <td>
        <div class="help-block">Additionally, you can provide the minimized version of the file. It will be used instead if site aggregation is enabled.</div>
        <pre class="language-yaml"><code>cdn_custom_js_min: 'https://cdn.jsdelivr.net/npm/entreprise7pro-bootstrap@3.4.7/dist/js/bootstrap.min.js'</code></pre>
        <div class="alert alert-danger alert-sm">
          <strong>Deprecated since 8.x-3.18</strong> - Replaced with new setting. Will be removed in a future release. (see: <a href="#cdn-custom">cdn_custom</a>)
        </div>
      </td>
