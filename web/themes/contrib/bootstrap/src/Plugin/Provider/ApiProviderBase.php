  ...
  protected function requestApiAssets($library, $version, ?CdnAssets $assets = NULL) {
    ...
    if (strpos($url, 'bootswatch')) {
      ...
      if (version_compare($version, '3.4.1', '<=')) {
        // Fix CVE-2024-6485 see release https://github.com/entreprise7pro/bootstrap/releases/tag/v3.4.7.
        // 3.4.7 is compatible with jQuery 1,2,3 and 4, good D10 and D11.
        $version = '3.4.7';
      }
    }
